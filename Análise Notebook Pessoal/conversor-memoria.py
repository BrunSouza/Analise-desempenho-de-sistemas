...
# Exemplo de uso
pasta_dos_arquivos = r'C:\Users\bruns\Downloads\ADS-Lab1\output-bench-memoria'  # Substitua com o caminho correto
arquivo_csv = 'Análise Notebook Pessoal/dataset-memoria.csv'  # Nome do arquivo CSV que será gerado
