...
# Exemplo de uso
pasta_dos_arquivos = r'/home/bruno.souza/Downloads/ADS-Lab1/output-bench-memoria'  # Substitua com o caminho correto
arquivo_csv = 'Análise Pc do Laboratório/dataset-memoria.csv'  # Nome do arquivo CSV que será gerado
